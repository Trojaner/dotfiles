...
[System.Environment]::SetEnvironmentVariable('EDITOR', 'code-insiders', 'User')
...
Set-ExecutionPolicy -Scope CurrentUser -ExecutionPolicy RemoteSigned -Confirm
Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass -Confirm
...
Install-PSResource -Repository PSGallery -Name CompletionPredictor -Scope CurrentUser -Confirm
Install-PSResource -Repository PSGallery -Name Get-ChildItemColor -Scope CurrentUser -Confirm
Install-PSResource -Repository PSGallery -Name Microsoft.WinGet.Client -Scope CurrentUser -Confirm
Install-PSResource -Repository PSGallery -Name Microsoft.WinGet.CommandNotFound -Scope CurrentUser -Confirm
Install-PSResource -Repository PSGallery -Name posh-git -Scope CurrentUser -Confirm
Install-PSResource -Repository PSGallery -Name PSReadLine -Scope CurrentUser -AllowPrerelease -Confirm
Install-PSResource -Repository PSGallery -Name Terminal-Icons -Scope CurrentUser -Confirm
